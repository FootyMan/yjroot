...
public class IosGetuiManager {

	// 您应用的appkey
	public static String appkey = "nHmwwAgPOT83Lf3S65Sev7";
	// 您应用的mastersecret
	public static String masterSecret = "A3GwNsQrCU9pN6i3LQ9TN7";
	// 您应用的appid
	public static String appId = "CMphRDekwuAWnowaDhbYLA";
	// host
