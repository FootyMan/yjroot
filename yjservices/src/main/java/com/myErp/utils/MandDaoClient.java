...
public class MandDaoClient {
	...
	private String sn = "SDK-DSN-010-00035";// 序列号
	private String password = "32@597c@";
	private String pwd = "";// 密码
	/**
	 * 签名
	 */
	public static String sign = "【欲见】";

	/*
	 * 构造函数
	 */
	public MandDaoClient() throws UnsupportedEncodingException {
