...
public class ProfitController {
	...
	public ModelAndView list(ProfitListModel proModel, Model model) {// Employee
		...
		List<UserFinancial> listData = userFinancialServiceImplERP.selectWdListByPage();
		for (UserFinancial f : listData) {
			...
			m.setOperateStatusName(FinancialOperateStatus.getFinancialOperateStatusByCode(detail.getOperateStatus()).getDesc());
			wdList.add(m);
		}
